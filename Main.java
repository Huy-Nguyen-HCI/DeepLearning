...
public class Main {
	...
	public static void main( String[] args ) {
		ConvolutionalLayer layer = new ConvolutionalLayer(2,3,2,1,ActivationFunctions.LINEAR, new double[]{1,0});
        ...
        MaxPoolingLayer maxPool = new MaxPoolingLayer( 2, 1, ActivationFunctions.LINEAR );
        maxPool.setInput( layer.getOutput() );
        Utilities.print3DMatrix( maxPool.getOutput() );
	}
}